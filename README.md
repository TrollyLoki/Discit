...
- The "Creative Mode" button can be used to **enable** specific Creative Mode settings on the server's currently loaded
  session (due to API limitations, the app cannot disable **any** Creative Mode settings)
