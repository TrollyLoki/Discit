...
@NullMarked
public final class ServerSettingsInteractions {
    private ServerSettingsInteractions() {
    }

    public static final String
            SERVER_SETTINGS_BUTTON_ID = "server-settings",
            SERVER_SETTINGS_MODAL_ID = "server-settings";

    public static void onSettingsButton(ButtonInteractionEvent event, String serverIdString) {
